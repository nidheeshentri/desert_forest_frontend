...
import CampaignManager from "@/components/campaigncomponents/campaignmanager"
...
const Campaigns: FC = () => {
  return (
    ...
    <Card className="col-span-1 md:col-span-2 lg:col-span-3 border-none"><CampaignManager /></Card>
