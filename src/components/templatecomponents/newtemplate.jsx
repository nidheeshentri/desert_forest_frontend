...
export default function TemplateCreator() {
  const { control, handleSubmit, watch, setValue, trigger, formState: { errors, isSubmitting, isDirty, isValid } } = useForm({
  ...
  const handleBold = useCallback(() => {
    ...
    if (contentRef.current) {
      handleContentChange({ currentTarget: contentRef.current })
    }
  }, [handleContentChange])
